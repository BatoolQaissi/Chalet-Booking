    ...
    [Bind("AccommodationId, StartAvailability, EndAvailability, PricePerNight, CleaningFee")] Offer offer)
{
    if (ModelState.IsValid)
    {
        ...
        offer.StartAvailability = offer.StartAvailability.ToUniversalTime();
        offer.EndAvailability = offer.EndAvailability.ToUniversalTime();
