...
namespace BookingApp.Areas.Identity.Pages.Account
{
    ...
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("تم تسجيل دخول المستخدم ذو المعرف '{UserId}' باستخدام رمز الاسترداد.", user.Id);
            ...
            {
                _logger.LogWarning("تم إدخال رمز استرداد غير صالح للمستخدم ذو المعرف '{UserId}' ", user.Id);
                ModelState.AddModelError(string.Empty, "تم إدخال رمز استرداد غير صالح.");
                return Page();
            }
        }
    }
