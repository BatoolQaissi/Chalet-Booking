...
namespace BookingApp
{
    ...
    public class AdvancedSearchController : ControllerBase
    {
        ...
        public async Task<IEnumerable<Offer>> Get(string city, string arrivalDate, string departureDate, string nbPerson)
        {
            ...
            DateTime arrivalDateTime = DateTime.ParseExact(arrivalDate, "yyyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture);
            DateTime departureDateTime = DateTime.ParseExact(departureDate, "yyyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture);
