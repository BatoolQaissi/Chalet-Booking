...
namespace BookingApp.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "يجب عليك إدخال عنوان بريدك الإلكتروني")]
            // Use regex because "[EmailAddress]" don't print error if there is no top-level domain
            [RegularExpression("^.+@.+\\..+$", ErrorMessage = "عنوان البريد الإلكتروني غير صالح")]
            [Display(Name = "البريد الإلكتروني")]
            public string Email { get; set; }

            [Required(ErrorMessage = "يجب عليك إدخال كلمة المرور الخاصة بك")]
